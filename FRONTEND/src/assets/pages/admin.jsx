                    ...
                    <div className="add-item-container">
                        <div className="add-rooms">
                            ...
                            <form onSubmit={handleSubmit}>
                                ...
                                <input type="text" name="ad_r_size" className="ad-r-size" onChange={handleInputChange} /><br />
                                <label htmlFor="entertainment">Entertainment</label>
                                <input type="text" name="ad_r_E" className="ad-r-E" onChange={handleInputChange} /><br />
                                <label htmlFor="connectivity">Connectivity</label>
                                <input type="text" name="ad_r_C" className="ad-r-C" onChange={handleInputChange} /><br />
                                <label htmlFor="butler">Butler Service</label>
                                <input type="text" name="ad_r_BS" className="ad-r-BS" onChange={handleInputChange} /><br />
                                <label htmlFor="guests">Guests</label>
                                <input type="text" name="ad_r_G" className="ad-r-G" onChange={handleInputChange} /><br />
                                <label htmlFor="location">Location</label>
                                <input type="text" name="ad_r_L" className="ad-r-L" onChange={handleInputChange} /><br />
                                <label htmlFor="occupancy">Occupancy</label>
                                <input type="text" name="ad_r_O" className="ad-r-O" onChange={handleInputChange} /><br />
                                <label htmlFor="refreshment">Refreshment</label>
                                <input type="text" name="ad_r_R" className="ad-r-R" onChange={handleInputChange} /><br />
                                <label htmlFor="extras">Extras</label>
                                <input type="text" name="ad_r_Extras" className="ad-r-Extras" onChange={handleInputChange} /><br />
